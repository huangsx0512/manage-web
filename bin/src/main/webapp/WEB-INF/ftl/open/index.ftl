...
<div class="container">
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt >应用权限管理</dt>
			<dd class="first_dd"><a href="javascript:void(0)" onclick="addTab('应用管理','${basePath}/admin/permission/list.shtml','')">应用管理</a></dd>
			<dd><a href="javascript:void(0)" onclick="addTab('应用角色管理','${basePath}/admin/role/list.shtml','')">应用角色管理</a></dd>
			<dd><a href="javascript:void(0)" onclick="addTab('应用权限管理','${basePath}/admin/subject/list.shtml','')">应用权限管理</a></dd>
		</dl>
		<!--
