package com.zimmur.platform.manage.web.shiro.service;
...
import com.zimmur.platform.manage.web.util.INI4j;
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule() {
		...
		try {
			...
			LOGGER.error(String.format("加载文件出错。file:[%s]", fileName), e);
		}
